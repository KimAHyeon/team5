...
<body>
	...
	<h4 class="font-thin"
		...
		<span style="font-size: 45px;">登録情報確認</span>
	</h4>
	<br>
	<form action="mypage" id="mypage" method="get">
		<fieldset>
			<table cellspacing="30">
				...
				<tr style="height: 60px;">
					<td colspan="2" style="text-align: center;"><a
						...
						type="button"
						style="width: 200px; background-color: white; border-color: #93b2ec; color: #93b2ec;">登録情報の編集ページに
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </a> <a
