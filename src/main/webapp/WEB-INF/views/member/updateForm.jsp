...
<body>
	...
	<br>
	<form action="updateMember" id="updateMember" method="POST">
		<fieldset>
			<table cellspacing="30">
				...
				<tr>
					...
					<td>
						...
						<p style="width: 20%; float: left">ID</p><input type="text" class="form-control" name="id"
								id="id" value="${member.id}" readonly="readonly" style="width:80%; float: left">
						</div>
						<p></p>
					</td>
				</tr>
					...
					<td>
						<div class="form-group">
							<p style="width:20%; float:left">パスワード</p>
							<input class="pw" type="text" id="pw" value="入力して下さい" style="width:80%; float:left;">
								<input class="passhidden" type="password" id="ps" name="commentps" style="width:80%; float:left;" />
						</div>
					...
					<td>	
						<div class="form-group">
							<p style="width:20%;float:left">ネーム</p>
							<input type="text" class="form-control" name="name"
								id="name" value="${member.name }"  style="width:80%; float:left;" readonly="readonly">
						</div>
						<p></p>
					</td>
				</tr>
				<tr style="height: 35px;">
					<td>
						<div class="form-group">
							<p style="width:20%; float:left;">所属学科</p>
